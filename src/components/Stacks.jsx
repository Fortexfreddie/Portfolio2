              ...
              <div className="grid grid-cols-2 xl:grid-cols-3 gap-4">
                {techStack.items.map((item, i) => (
                  ...
                  >
                    ...
                    <span className="text-md font-medium text-gray-700 dark:text-gray-200 transition-colors duration-300">
                      {item.name}
                    </span>
                    <div className="flex flex-col justify-end h-full w-full mt-3">
                      ...
                      <progress
                        ...
                        max="100"
                        className="mt-1 w-full h-2 rounded [&::-webkit-progress-bar]:bg-gray-200 dark:[&::-webkit-progress-bar]:bg-gray-400 [&::-webkit-progress-bar]:rounded [&::-webkit-progress-value]:bg-emerald-600 [&::-webkit-progress-value]:rounded transition-all duration-300"
                      ></progress>
                    </div>
                  </motion.div>
                ))}
