    ...
    return (  
        <section className="pt-20 pb-10 w-full transition-colors duration-300">
            <div className="lg:container mx-auto px-6 md:px-8 lg:px-12">
                <h1 className="text-center text-3xl md:text-4xl font-bold tracking-wider text-gray-900 dark:text-gray-50 transition-colors duration-300">Experience & Education</h1>
                ...
                {experience.map((exp, i) => (
                    <div key={i} className="bg-gray-100 dark:bg-gray-900 rounded-xl p-6 border border-gray-300 dark:border-gray-600 transition-all duration-300">
                ...
                <div className="bg-gray-100 dark:bg-gray-900 rounded-xl p-6 border border-gray-300 dark:border-gray-600 mt-12 transition-all duration-300">
