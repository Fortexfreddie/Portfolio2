...
const Contact = () => {
    return (
      <section
        id="Contact"
        className="pt-20 w-full transition-colors duration-300"
      >
        <div className="lg:container mx-auto px-6 md:px-8 lg:px-12">
          ...
          <p className="mt-6 text-lg text-gray-600 dark:text-gray-300 text-center transition-colors duration-300">
            “Got a project or idea? Reach out via WhatsApp using the button
            below, I'm open to freelance work, collaborations, or a quick chat.”
          </p>
          ...
          <div className="mt-10">
            <div className="relative flex items-center justify-center w-72 h-72 mx-auto">
              ...
              <a
                href="https://api.whatsapp.com/send/?phone=2347085062472&text&type=phone_number&app_absent=0"
                target="_blank"
                rel="noopener noreferrer"
                className="relative bg-gray-900 dark:bg-gray-800 text-gray-300 dark:text-gray-100 px-6 py-3 rounded-lg shadow-md z-10 hover:bg-gray-950 active:bg-gray-950 dark:hover:bg-gray-700 dark:active:bg-gray-700 transition-all duration-300 cursor-pointer"
              >
                Let’s Work
              </a>
            </div>
        ...
        <footer className="mt-6 py-6 text-center bg-gray-800">
          <div className="flex justify-center gap-4 mb-4">
            ...
            <a
              href="https://www.linkedin.com/in/fred-kamsy-91685b295?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app"
              target="_blank"
              rel="noopener noreferrer"
              className="text-gray-300 hover:text-white transition-colors duration-300"
            >
            ...
            <a
              href="https://twitter.com/fortexfreddie"
              target="_blank"
              rel="noopener noreferrer"
              className="text-gray-300 hover:text-white transition-colors duration-300"
            >
            ...
            <a
              href="mailto:kamyz042@gmail.com"
              className="text-gray-300 hover:text-white transition-colors duration-300"
            >
              <FaEnvelope size={20} />
            </a>
          ...
          <p className="text-sm text-gray-300">
            © 2025 Freddie's Works. All rights reserved.
          </p>
